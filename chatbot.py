...
load_dotenv()
api_key = "AIzaSyBtQLmOlXrdaIpUZ3ukNO91NN4Av06jePQ"
...
<blockquote>
    Hello! <br>
    I am a top-class chef and would be happy to answer any questions you have about recipes or food.. <br><br>
...
Try to return nutritional and recipe information in HTML tags. If the user asks a question other than food-related questions, then return "Oops! That’s not on my menu. Try something food-related!". 
